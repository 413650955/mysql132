...
?>
<input type="button" value="同意" class="btn" onclick="acceptNewDrug(<?php echo $row['newdrug_id'];?>)">
<input type="button" value="拒绝" class="btn" onclick="refuseNewDrug(<?php echo $row['newdrug_id'];?>)">
</body>
<script type="text/javascript">

	function acceptNewDrug(id1){
			window.location="acceptNewDrug.php?id1="+id1;
	}
	function refuseNewDrug(id1){
			window.location="refuseNewDrug.php?id1="+id1;
	}
</script>
</html>