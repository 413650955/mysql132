                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php  foreach($rows as $row):?>
                            <tr>
                                ...
                                <td align="center"><input type="button" value="删除" class="btn" onclick="deleteOneDrug(<?php echo $row['drug_id'];?>)"></td>
                            </tr>
                            <?php endforeach;?>
...
<script type="text/javascript">
	function deleteOneDrug(id){
			window.location="deleteOneDrug.php?id="+id;
	}
</script>
</body>
</html>