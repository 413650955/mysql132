...
<?php
	...
	$sql="select * from t_store where store_permit='1'";
	...
	$sql="select  * from t_store where store_permit='1'  limit {$offset},{$pageSize}";
	$rows=fetchAll($sql,$link);
?>
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <?php  foreach($rows as $row):?>
                            <tr>
                                ...
                                <td align="center"><?php echo $row['store_name'];?></td>
                                <td align="center"><?php echo $row['store_keep'];?></td>
